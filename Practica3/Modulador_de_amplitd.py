...
from ModuloAm import ModuloAm  # grc-generated hier_block
...
class Modulador_de_amplitd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulador_de_amplitd")
        ...
        self._K_range = Range(-4, 4, 0.5, 1, 200)
        self._K_win = RangeWidget(self._K_range, self.set_K, "Coefciente de sesibilidad ka", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        # Connections
        ##################################################
        self.connect((self.ModuloAm_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.ModuloAm_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModuloAm_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuloAm_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuloAm_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.CalculoDePotenciaComunicaciones_0, 0))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModuloAm_0.set_Ac(self.Ac)




def main(top_block_cls=Modulador_de_amplitd, options=None):
