...
class blooques(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "blooques")
        ...
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud de la señal TX", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=blooques, options=None):
