...
class muliplex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "muliplex")
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecencia mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fs, Am, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fs, Am, 0, 0)
        ...
        self._Ds_range = Range(0, 100, 1, 0, 200)
        self._Ds_win = RangeWidget(self._Ds_range, self.set_Ds, "Retardo audio", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Ds_win)
        ...
        self.connect((self.ModulacionPAM_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.ModulacionPAM_1, 0), (self.rational_resampler_xxx_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.ModulacionPAM_0_2, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModulacionPAM_0_0, 0))
...
def main(top_block_cls=muliplex, options=None):
