...
class Practica4A(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica4A")
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecuencia señal Portadora", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Practica4A, options=None):
