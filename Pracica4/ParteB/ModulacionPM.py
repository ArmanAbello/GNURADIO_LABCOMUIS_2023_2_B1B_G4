...
from Envolvente_Compleja_PM import Envolvente_Compleja_PM  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._kp_range = Range(0, 50, 1e-6, 10, 200)
        ...
        self._fc_range = Range(50e6, 2e9, 1e6, 100e6, 200)
        ...
        self._DC_range = Range(0, 10, 0.000001, 1, 200)
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "'DC'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, DC, 0)
        self.Envolvente_Compleja_PM_0 = Envolvente_Compleja_PM(
            Ac=Ac,
            kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_Compleja_PM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_Compleja_PM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Envolvente_Compleja_PM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_Compleja_PM_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.Envolvente_Compleja_PM_0.set_kp(self.kp)
    ...
    def set_DC(self, DC):
        self.DC = DC
        self.analog_sig_source_x_0.set_offset(self.DC)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Envolvente_Compleja_PM_0.set_Ac(self.Ac)
